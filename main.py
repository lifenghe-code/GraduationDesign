...
def main():
    ...
    np.savetxt("./img_txt/pareto_in/pareto_in.txt", pareto_in)  # 保存pareto边界粒子的坐标
    np.savetxt("./img_txt/pareto_fitness/pareto_fitness.txt", pareto_fitness)  # 打印pareto边界粒子的适应值
